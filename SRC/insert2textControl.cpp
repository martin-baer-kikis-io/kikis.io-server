...
/* ------------------------------------------------------------------------------*
 *
 * Inserts a string into each text control that matches the internal 'and'
 * 
 *     name="element - A text control.</param>
 *     name="value - The string to be inserted.</param>
 *
 *------------------------------------------------------------------------------*/
...
#include "utils.h"
 ...
 void insert_string_to_text_control(AutomationElement element, string value)
{
   try
    {
            ...
            ValuePattern.Pattern, out valuePattern))
        {
            ...
            {
                //string currVal =
				//((ValuePattern)valuePattern).Current.Value.ToString();
...
/* ------------------------------------------------------------------------------*
 *
 * the internal 'and' condition.  probably needs to be wrapped in a main or
 * a function.
 *      
 *      
 *
...
{
    insert_to_text_control(x, "Hello World!");
}
...
void NotepadInsertButton_Click(object sender, EventArgs e)
{
